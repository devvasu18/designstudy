...
export default function ProfileDashboard() {
  ...
  return (
    <div className={`min-h-screen overflow-x-hidden overflow-y-auto scrollbar-hide transition-colors duration-300 ${
      ...
      <div className="max-w-7xl mx-auto p-5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 mb-10">
          {/* Core Skills Card */}
          <div className={`border rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg relative overflow-hidden ${
            isDarkMode 
            ...
            {/* Card Title */}
            <div className={`flex items-center gap-3 text-2xl font-bold mb-6 transition-colors duration-300 ${
          ...
          <div className={`border rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg relative overflow-hidden ${
            ...
            <div className="space-y-4">
              {personalityTraits.map((trait, index) => (
                <div 
                  key={index} 
                  className={`rounded-xl p-4 border-l-4 border-pink-500 transition-all duration-300 hover:translate-x-2 ${
                    isDarkMode 
          ...
          <div className={`border rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg relative overflow-hidden ${
            ...
            <div className="flex flex-col items-center">
              <div className="relative w-30 h-30 mb-5">
                ...
                <div className={`absolute inset-2 rounded-full flex items-center justify-center border-4 transition-colors duration-300 ${
                  isDarkMode 
