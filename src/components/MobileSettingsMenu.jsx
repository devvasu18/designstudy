      ...
      ">
        ...
        ">
          ...
          <div style="display: flex; gap: 16px; justify-content: center; flex-wrap: wrap;">
            ...
            <a href="https://www.instagram.com/direct/new/" target="_blank" onclick="
              const shareText = 'Discover amazing Instagram stories, see who viewed your profile, and unlock premium features! 📱✨ ' + window.location.origin;
              if (navigator.clipboard) {
                navigator.clipboard.writeText(shareText).then(() => {
                  const notification = document.createElement('div');
                  notification.innerHTML = '<div style=&quot;position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);background:rgba(0,0,0,0.8);color:white;padding:12px 20px;border-radius:8px;z-index:10001;font-family:system-ui;font-size:14px;&quot;>📋 Link copied! Paste it in Instagram chat</div>';
                  document.body.appendChild(notification);
